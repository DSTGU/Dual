...
use crate::primitives::consts::{DATAGEN_DEPTH, DEPTH_SCALE};
...
fn generate(n: usize, seed: u64, book: &[String], out: &mut dyn Write) -> io::Result<usize> {
    ...
    while written < n {
        ...
        search_state.reset_for_new_iteration(DATAGEN_DEPTH * DEPTH_SCALE);
        let result = single_depth_search(&board, &mut search_state, DATAGEN_DEPTH * DEPTH_SCALE);
